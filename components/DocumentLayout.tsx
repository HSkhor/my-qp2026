  ...
  return (
    <div className="flex justify-center w-full print:block print:w-full">
      {/* 
         A4 Container 
         - Screen: max-w-[210mm]
         - Print: max-width: 180mm (Approx 90% of A4 width), centered, padding-right: 10mm
      */}
      <div 
        className="
          ...
          print:max-w-[180mm] print:w-[90%] print:mx-auto print:h-auto
          print:pr-[10mm] print:box-border
        "
        style={{ boxSizing: 'border-box' }}
      >
        
        {/* 
            Print-specific scaling wrapper to fit content.
            Scale 0.9 to ensure it fits safely within the 180mm container if content is wide.
        */}
        <div className="w-full h-full flex flex-col print:origin-top-left print:scale-95 print:w-[105%]">
            ...
            {/* Header Section */}
            {!isCover && (
            <div className="p-4 md:p-8 pb-4 mx-2 md:mx-8 mt-4 md:mt-8 print:mx-4 print:mt-4 print:p-0">
            ...
            {/* Main Content Body */}
            {/* Adjusted padding for print to ensure safe margins */}
            <div className={`flex-grow ${isCover ? 'p-0' : 'px-4 md:px-12 py-6 print:px-4 print:py-4 print:pb-8'} relative z-20 overflow-visible`}>
            {children}
            </div>

            {/* Footer - Positioned Absolute Bottom with reduced size */}
            <div className="p-2 text-center mt-auto w-full z-30 print:absolute print:bottom-0 print:left-0 print:w-full">
